---
title: 从传统编程转向大模型编程
source_url: https://mp.weixin.qq.com/s/S9XBcdof43MdwYd2tXGl1Q
saved: 2026-05-09
...
- \_例如\_：“当用户要求代码审查时，请先运行下方的 Python 脚本，然后根据输出结果给出建议。”

**2\. 手脚 (Scripts/Tools)**

- 这是具体的执行脚本（Python/Bash/Node.js 等）。
- \_例如\_： `check_coverage.py` （查覆盖率）、 `format_json.py` （格式化数据）。
